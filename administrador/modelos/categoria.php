...
class categorias{
    ...
    public static function consultarCategoria(){
        ...
        foreach($sql->fetchAll() as $categoria){
            // Acá tuve que pasar todos los datos que están en el constructor para que funcionara 
            $listaCategoria[]=new categorias($categoria['id_categoria'],$categoria['categoria'],$articulos['id_articulos'],$articulos['nombre_articulo'],$articulos['codigo_articulo'],$articulos['descripcion'],$articulos['precio_venta'],$articulos['imagen'],$articulos['cantidad'],$articulos['estado'],$articulos['descuento']);
        }
    ...
    public static function buscar($categoria){
        ...
        foreach($sql->fetchAll() as $articulos){
            $listarCategorias[]=new categorias($categoria['id_categoria'],$articulos['categoria'],$articulos['id_articulos'],$articulos['nombre_articulo'],$articulos['codigo_articulo'],$articulos['descripcion'],$articulos['precio_venta'],$articulos['imagen'],$articulos['cantidad'],$articulos['estado'],$articulos['descuento']);
        }
