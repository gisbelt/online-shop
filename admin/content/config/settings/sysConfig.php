...
define("_ROUTE_" , "http://localhost/proyecto-uptaeb/admin");					/* direccion del proyecto */
define("_THEME_" , "http://localhost/proyecto-uptaeb/admin/asset");			/* Direccion de recursos y estilos */
define("_INDEX_FILE_" , "http://localhost/proyecto-uptaeb/admin/index.php");	/* direccion del archivo index */
